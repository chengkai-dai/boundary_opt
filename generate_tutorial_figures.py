...
<text x="550" y="425" text-anchor="middle" class="math label">L = Σf w_f (q_f / μ − 1)²,   q_f = |∇u_f|²,   μ = Σf w_f q_f</text>
<text x="550" y="470" text-anchor="middle" class="small">L = 0 only when every triangle has the same squared gradient magnitude.</text>
"""
